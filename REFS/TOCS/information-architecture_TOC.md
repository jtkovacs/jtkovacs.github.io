	...
	- [What are controlled vocabularies?](#what-are-controlled-vocabularies?)
		...
		- [Constructing CVs](#constructing-cvs)
			...
			- [Specifying relationships](#specifying-relationships)
				- [Choosing preferred term](#choosing-preferred-term)
...
Terms can be generated by a committee (top-down, bottom-up); by empirical methods (deductive, inductive); by a machine; or from an existing CV (don't duplicate!). 

Terms are chosen from a specific domain/information space if their inclusion is warranted. Since warrants shift over time, a taxonomist may also have a 'parking lot' for candidate terms AKA provisional terms:
...
**Scope & coordination:** The basic rule is that term should denote a single concept, or unit of thought. Classes of things denoted by terms:
