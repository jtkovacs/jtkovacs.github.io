<p class="path"><a href="../pkb.html">pkb contents</a> \> bi | just under 4685 words | updated 12/27/2017</p><div class="TOC">- &nbsp;1. [What is BI?](#what-is-bi)
	...
	- &nbsp;2.5. [Interpreting the data](#interpreting-the-data)
		...
		- &nbsp;2.5.2. [Analytic deliverables](#analytic-deliverables)
			...
			- &nbsp;2.5.2.2. [Data mining](#data-mining)
				- &nbsp;2.5.2.2.1. [DM applications by technique](#dm-applications-by-technique)
				- &nbsp;2.5.2.2.2. [DM applications by industry](#dm-applications-by-industry)
				- &nbsp;2.5.2.2.3. [DM processes](#dm-processes)
				- &nbsp;2.5.2.2.4. [DM software](#dm-software)
				- &nbsp;2.5.2.2.5. [Common DM pitfalls](#common-dm-pitfalls)
...
##### 2.5.2.2.1. DM applications by technique
...
##### 2.5.2.2.2. DM applications by industry
