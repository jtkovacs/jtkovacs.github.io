<p class="path"><a href="../pkb.html">pkb contents</a> \> pim | just under 2792 words | updated 05/23/2017</p><div class="TOC">- &nbsp;1. [Personal ... ](#personal-...-)
	...
	- &nbsp;1.3. [PIM & PKM tools](#pim-pkm-tools)
		- &nbsp;1.3.1. [Content management](#content-management)
			- &nbsp;1.3.1.1. [Record-keeping](#record-keeping)
				- &nbsp;1.3.1.1.1. [What is a personal knowledge base?](#what-is-a-personal-knowledge-base)
				- &nbsp;1.3.1.1.2. [What is a wiki?](#what-is-a-wiki)
		- &nbsp;1.3.2. [Time & task management](#time-task-management)
		- &nbsp;1.3.3. [Communication](#communication)
		- &nbsp;1.3.4. [Content discovery](#content-discovery)
- &nbsp;2. [Browser performance](#browser-performance)
- &nbsp;3. [Personal privacy & security](#personal-privacy-security)
	...
	- &nbsp;3.3. [Account security](#account-security)
		...
		- &nbsp;3.3.2. [Protect login information](#protect-login-information)
		- &nbsp;3.3.3. [Limit 3p access](#limit-3p-access)
...
#### 1.3.1.1. Record-keeping
    
- Personal notes/journal
- Legal documents
- Education records

##### 1.3.1.1.1. What is a personal knowledge base?
...
### 3.3.2. Protect login information
